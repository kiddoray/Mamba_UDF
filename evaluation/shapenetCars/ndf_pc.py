...
def evaluate_pcs(gt_path, es_path, n_points=100000, normalize=False):
    es_pcs = np.load(es_path)['point_cloud'][:n_points]
...
if __name__ == '__main__':
    ...
    pred_file = os.path.join(conf.get_string('general.base_exp_dir'), args.dir, 'pointcloud', 'ndf.npz')


    evaluate_pcs(gt_file, pred_file, 100000)
