...
class Runner:
    def __init__(self, args, conf_path):
        ...
        self.step_inter = self.conf.get_int('train.step_inter')
    ...
    def train(self):
        ...
        # writer = SummaryWriter('level_loss')
        ...
        for iter_i in tqdm(range(self.iter_step, self.step2_maxiter)):
            ...
            # writer.add_scalar("22c0 level loss",loss, self.iter_step)
            ...
            if self.iter_step == self.step1_maxiter or self.iter_step == self.step2_maxiter or self.iter_step == self.step_inter: 
